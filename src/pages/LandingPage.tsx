      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 h-16 flex items-center justify-between gap-2">
        <a href="#top" className="flex items-center">
          <img
            ...
            width={180}
            height={56}
            className="h-10 sm:h-14 w-auto max-w-[120px] sm:max-w-none"
            fetchPriority="high"
            loading="eager"
            decoding="async"
            onError={(e) => {
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          <a
            ...
            className="inline-flex w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-ink-200 items-center justify-center text-ink-500 hover:text-ink-900 hover:border-ink-400 transition-colors shrink-0"
          ...
          <Link to="/login" className="btn-primary rounded-full px-3 sm:px-4 py-2 text-[13px] font-display font-medium inline-flex items-center gap-1.5">
            <LogIn size={14} />
