          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <code className="bg-muted border px-3 py-1.5 rounded text-xs font-mono flex-1 truncate">
                  {baseUrl}/api/v1
                </code>
                <Button
                  variant="outline"
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mb-2">
                Envie sua chave de API no header <code className="bg-muted px-1 rounded">X-API-Key</code>:
              </p>
