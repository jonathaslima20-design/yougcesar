...
import { LayoutDashboard, Users, Settings, LogOut, Menu, X, ShieldCheck, Gift, CreditCard, CircleHelp as HelpCircle, UsersRound, Wallet, Scale, UserX, Smartphone, Paintbrush, Megaphone, Globe, Link2, Bell, Tag, Newspaper, Handshake, Eye, Boxes, MessageSquareQuote, Percent } from 'lucide-react';
  ...
  const navigationGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Taxa da Plataforma (MP)', href: '/admin/mercadopago-marketplace', icon: Percent, roles: ['admin'] },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Depoimentos', href: '/admin/landing-testimonials', icon: MessageSquareQuote, roles: ['admin'] },
        { name: 'Blog', href: '/admin/blog', icon: Newspaper, roles: ['admin'] },
      ],
    },
    {
      label: 'Sistema',
      items: [
        ...
        { name: 'Monitoramento', href: '/admin/monitoring', icon: Eye, roles: ['admin'] },
